      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Bienvenido a Ucú Reporta</h1>
          </div>
        ...
        >
          <p className="text-sm">© 2025 Municipio de Ucú, Yucatán - Todos los derechos reservados</p>
        </motion.div>
      </div>
